...
public:
    ...
    void ReadHeading();
    long GetAltitude() { return Alt_tel_s; }
    long GetAzimuth() { return Az_tel_s; }
...
private:
    ...
    static const uint8_t Mmode = 0x02;        // 2 for 8 Hz, 6 for 100 Hz continuous magnetometer data read
    float mRes;
    float aRes;
    float gRes;
